public static class Damage
{
    ...
    /// <returns></returns>
    public static float NormalDamage(int atkValue, int defValue) => 10 + (atkValue / (0.5f * defValue + 10)) * 15 - defValue / 5;
    ...
    /// <param name="defValue"></param>
    /// <returns></returns>
    public static float CritDamage(int atkValue, int defValue) => (10 + (atkValue / (0.5f * defValue + 10)) * 15 - defValue / 5) * 1.5f;
}
