...
public class MoveSystem
{
    ...
    public void CalculateRange(Unit selects, HexGridStore hexGrid) => moveRange = PathFind.PathGetRange(hexGrid, selects.CurrentHexPos, selects.UnitData.MovePoints);
